...
void ProtocolLogin::onRecvFirstMessage(NetworkMessage& msg)
{
	...
	g_dispatcher.addTask([=, thisPtr = std::static_pointer_cast<ProtocolLogin>(shared_from_this()), accountName = std::move(accountName), password = std::move(password), authToken = std::move(authToken)]() {
